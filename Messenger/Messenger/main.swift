...
public extension CommandLine {
    static var argv: UnsafeMutablePointer<UnsafeMutablePointer<Int8>>! {
        let ptr = self.unsafeArgv;
...
UIApplicationMain(CommandLine.argc, CommandLine.argv, NSStringFromClass(Application.self), NSStringFromClass(Application.AppDelegate.self))
